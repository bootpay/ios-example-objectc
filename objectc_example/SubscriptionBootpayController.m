//
//  SubscriptionBootpayController.m
//  objectc_example
//
...
@interface SubscriptionBootpayController ()

@end

@implementation SubscriptionBootpayController
...
//    payload.orderId = [NSString stringWithFormat:@"%f", timeStamp];
    payload.subscriptionId = [NSString stringWithFormat:@"%f", timeStamp];
    payload.pg = @"웰컴";
    payload.method = @"카드자동";
...
//
    [[[[[[[Bootpay requestSubscription:self
                               :payload
                               :true
